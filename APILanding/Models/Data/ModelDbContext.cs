...
public partial class ModelDbContext : DbContext
{
    ...
    public virtual DbSet<TblWareHouseZone> TblWareHouseZones { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source= DESKTOP-HJ8UUA1\\SQLEXPRESS01;Initial Catalog=dbiBos; Trusted_Connection =True; Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TblWareHouseZone>(entity =>
        {
            entity.HasKey(e => e.IntAutoId);

            entity.ToTable("tblWareHouseZone", "tms");
            ...
            entity.Property(e => e.IntWhid).HasColumnName("intWHID");
